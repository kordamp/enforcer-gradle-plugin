 ...
 */
@CompileStatic
abstract class AbstractStandardEnforcerRule extends AbstractFilteringEnforcerRule {
    final Property<String> message

    AbstractStandardEnforcerRule(ObjectFactory objects) {
        this(objects, EnforcerPhase.values())
    }

    AbstractStandardEnforcerRule(ObjectFactory objects, EnforcerPhase[] allowedPhases) {
